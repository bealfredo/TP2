...
@Component({
  selector: 'app-cliente-form-self',
  standalone: true,
  ...
  templateUrl: './cliente-form-self.component.html',
  styleUrl: './cliente-form-self.component.css'
})
export class ClienteFormSelfComponent {
